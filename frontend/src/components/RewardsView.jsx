  ...
  return (
    <div className="space-y-6">
      <div className="pb-4 border-b border-slate-200">
        ...
        <p className="text-xs text-slate-500 mt-1 font-medium">View active coupons, loyalties, and promotional benefits</p>
      </div>
      ...
      <div className="space-y-4 pt-4">
        <h3 className="font-extrabold text-sm text-slate-700 tracking-tight uppercase tracking-wider">Active Promo Codes & Coupons</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          
          {/* Coupon 1 */}
          <div className="bg-white/30 border border-dashed border-slate-200 rounded-2xl p-5 relative overflow-hidden flex gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-xs bg-slate-50 border border-slate-200 px-2 py-0.5 rounded text-indigo-300 uppercase tracking-widest font-mono select-all">FIXVO10</span>
          ...
          <div className="bg-white/30 border border-dashed border-slate-200 rounded-2xl p-5 relative overflow-hidden flex gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-xs bg-slate-50 border border-slate-200 px-2 py-0.5 rounded text-amber-400 uppercase tracking-widest font-mono select-all">PLUSNEW</span>
