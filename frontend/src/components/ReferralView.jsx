...
const ReferralView = ({ profile, showToast }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-[#1E293B] to-slate-950 p-6 rounded-3xl border border-slate-200 relative overflow-hidden text-center space-y-6">
        ...
        <div className="space-y-1.5 max-w-sm mx-auto">
          <h3 className="text-lg font-black text-slate-900">Earn ₹100 for every referral!</h3>
        ...
        {/* Copy code input */}
        <div className="flex max-w-xs mx-auto border border-slate-200 bg-slate-50 rounded-2xl overflow-hidden p-1.5 items-center justify-between">
          <span className="font-black text-sm uppercase tracking-widest pl-3.5 text-slate-800">{refCode}</span>
          <button
            type="button"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 text-center">
          ...
          <p className="text-2xl font-black text-slate-900 mt-1.5">3</p>
        </div>
        <div className="bg-white p-5 rounded-2xl border border-slate-200 text-center">
