...
export const globalServices = [
  ...
  { id: 'microwave', categoryId: 'repair', name: 'Microwave Repair', icon: Sparkles, color: 'text-orange-500', bg: 'bg-orange-500/20', img: 'https://images.unsplash.com/photo-1585659722983-3a675dabf23d?q=80&w=600&auto=format&fit=crop' },
  ...
  { id: 'laptop_repair', categoryId: 'repair', name: 'Laptop Repair', icon: Smartphone, color: 'text-slate-500', bg: 'bg-slate-500/20', img: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?q=80&w=600&auto=format&fit=crop' },
  ...
  // Installation
  { id: 'ac_install', categoryId: 'installation', name: 'AC Installation', icon: Wind, color: 'text-sky-500', bg: 'bg-sky-500/20', img: 'https://images.unsplash.com/photo-1631545856760-4966d5d59f13?q=80&w=600&auto=format&fit=crop' },
  { id: 'cctv_install', categoryId: 'installation', name: 'CCTV Installation', icon: Hammer, color: 'text-zinc-500', bg: 'bg-zinc-500/20', img: 'https://images.unsplash.com/photo-1557597774-9d273605dfa9?q=80&w=600&auto=format&fit=crop' },
  { id: 'ro_install', categoryId: 'installation', name: 'RO Installation', icon: Droplets, color: 'text-blue-500', bg: 'bg-blue-500/20', img: 'https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?q=80&w=600&auto=format&fit=crop' },
  { id: 'inverter_install', categoryId: 'installation', name: 'Inverter Installation', icon: Zap, color: 'text-amber-500', bg: 'bg-amber-500/20', img: 'https://images.unsplash.com/photo-1558441719-443b38605ad3?q=80&w=600&auto=format&fit=crop' },
  { id: 'fan_install', categoryId: 'installation', name: 'Ceiling Fan Installation', icon: Wind, color: 'text-slate-500', bg: 'bg-slate-500/20', img: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?q=80&w=600&auto=format&fit=crop' },
  ...
  { id: 'furniture', categoryId: 'installation', name: 'Furniture Assembly', icon: Hammer, color: 'text-orange-500', bg: 'bg-orange-500/20', img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=600&auto=format&fit=crop' },
  ...
  { id: 'water_tank_clean', categoryId: 'cleaning', name: 'Water Tank Cleaning', icon: Droplets, color: 'text-blue-600', bg: 'bg-blue-600/20', img: 'https://images.unsplash.com/photo-1517646287270-a5a9ca602e5c?q=80&w=600&auto=format&fit=crop' },
  ...
  { id: 'home_clean', categoryId: 'cleaning', name: 'Full Home Cleaning', icon: Home, color: 'text-emerald-500', bg: 'bg-emerald-500/20', img: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600&auto=format&fit=crop' },
