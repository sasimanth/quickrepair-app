  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose max-w-none text-gray-700">
        <p className="mb-4">The information provided by QuickRepair on our platform is for general informational purposes only. All information on the site is provided in good faith, however, we make no representation or warranty of any kind.</p>
        ...
        <p className="mb-4">QuickRepair is not responsible for inherent manufacturer defects, structural deterioration, or past damages to appliances. Interventions by our technicians are geared towards fixing the immediate reported issue.</p>
