...
const globalServices = [
  ...
  { id: 'lock_install', categoryId: 'installation', name: 'Door Lock Installation', color: 'text-yellow-600', bg: 'bg-yellow-600/20', image: 'https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=600&auto=format&fit=crop', description: 'Digital and manual door lock install' },
  ...
  { id: 'carpet_clean', categoryId: 'cleaning', name: 'Carpet Cleaning', color: 'text-indigo-400', bg: 'bg-indigo-400/20', image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600&auto=format&fit=crop', description: 'Carpet shampooing and dry clean' },
